...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        time_h.C_POINTER.withName("__routine"),
        time_h.C_POINTER.withName("__arg"),
        time_h.C_POINTER.withName("__next")
    ...
    public final static class __routine {
        ...
        private static final MethodHandle UP$MH = time_h.upcallHandle(__routine.Function.class, "apply", $DESC);
